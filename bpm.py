...
#? Heart Rate Calculation Variable
...
while(True):
    ...
    if bboxs:
        ...
        cv2.rectangle(frameDraw[0],bboxs[0]['bbox'],(255,0,255),2)
        ...
        #if bpm_value > 90:
            #cvzone.putTextRect(frameDraw,f'Fast Heart rate: ', scale=1)
